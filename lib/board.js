...
function Board(){
  this.nodes = setupNodeGrid();
  this.upLists = createUpLists(nodes);
  this.downLists = createDownLists(nodes);
  this.leftLists = createRightLists(nodes);
  this.rightLists = createLeftLists(nodes);
  setupBoard();
}
