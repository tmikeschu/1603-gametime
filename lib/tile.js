...
Tile.prototype.drawTile = function () {
  ...
  if (this.currentNode.data === null) {
    ...
    var img = new Image();
    img.src = Images[this.currentNode.data];
    var context = this.context;
    img.onload = function() {
      var pattern = context.createPattern(img, "no-repeat");
      context.fillStyle = pattern;
      context.fillRect(coordinates.x, coordinates.y, 100, 100);
    };
    this.context.fillText(Images[this.currentNode.data], coordinates.x + 35, coordinates.y + 70);
  }
};
